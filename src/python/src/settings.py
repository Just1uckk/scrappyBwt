...
RABBITMQ_SITEMAP_RESULTS = os.getenv("RABBITMQ_SITEMAP_RESULTS", "")
RABBITMQ_INFO_TASKS = os.getenv("RABBITMQ_INFO_TASKS", "")
RABBITMQ_INFO_RESULTS = os.getenv("RABBITMQ_INFO_RESULTS", "")
RABBITMQ_INFO_REPLIES = os.getenv("RABBITMQ_INFO_REPLIES", "")
